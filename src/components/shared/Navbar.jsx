...
function Navbar() {
  ...
  return (
    <NavContainer>
      <LogoAndTitle>
        <img  src="/imagenes/logodejardin.png" 
          width="80" 
          height="70" 
          alt="Logo del Jardín Botánico Martín Cárdenas" 
        />
        <h2>Jardín Botánico <span>Martín Cárdenas</span></h2>
      </LogoAndTitle> 
      <div className={`links ${clicked ?'active': '' } `}>
        <NavLink end to="/inicio" className="nav-link">Inicio</NavLink>
        <NavLink to="/Clasificacion-de-las-plantas" className="nav-link">Clasificación de las plantas</NavLink>
        <NavLink to="/escanear-planta" className="nav-link">Escanear planta</NavLink>
        <NavLink to="/como-llegar" className="nav-link">¿Cómo llegar?</NavLink>
